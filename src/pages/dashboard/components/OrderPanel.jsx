...
const OrderPanel = ({
  ...
  useEffect(() => {
    ...
    async function fetchChain() {
      ...
      try {
        const data = await apiService.get("options/chain", { symbol: selectedStock.name });
        ...
        const ltp = data?.underlyingValue ?? data?.ltp ?? data?.currentPrice ?? null;
        setCurrentPrice(ltp);
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div>
                  ...
                  {priceChange != null && (
                    <div style={{ fontSize: "0.65rem", color: priceColor, marginTop: 2 }}>
                      {pricePositive ? "▲" : "▼"} {priceChange >= 0 ? "+" : ""}{Number(priceChange).toFixed(2)}
              ...
              <div style={{
                flex: 1, height: 28,
                background: currentPrice ? `${priceColor}14` : "rgba(75,85,99,0.08)",
